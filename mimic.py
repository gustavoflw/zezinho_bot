...
class Mimic:
    def __init__(self, user_id, channel_id):
        ...
        self.num_channel_last_messages = 5 # The number of messages from the channel that the bot will use to generate a response (including messages from all users since the bot was first triggered)
        ...
        self.context = ["Você é um bot chamado Zezinho.",
    ...
    def mimic(self) -> str:
        ...
        prompt = f"{prompt} Tambem se esforce para nao repetir ideias no contexto da conversa."
